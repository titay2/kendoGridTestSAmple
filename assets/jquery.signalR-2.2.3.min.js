          ...
          : s(
            ...
            : (p(a),
              ...
              this.isCrossDomain(a.url) &&
                ...
                typeof v.withCredentials == "undefined" &&
                  (v.withCredentials = !0),
                v.jsonp ||
                ...
                if (a.state !== r.connectionState.disconnected) {
                  ...
                  try {
                    a._.initHandler.start(
                      ...
                      function() {
                        var i =
                            r._.firefoxMajorVersion(t.navigator.userAgent) >=
                            11,
                ...
                success: function(t) {
                  ...
                  if (
                    ...
                    (a._.totalTransportConnectTimeout =
                      a.transportConnectTimeout +
                      i.TransportConnectTimeout * 1e3),
                    i.KeepAliveTimeout
                      ? ((e.activated = !0),
                      ...
                      : (e.activated = !1),
                    (a.reconnectWindow =
                      a.disconnectTimeout + (e.timeout || 0)),
                    !i.ProtocolVersion ||
                      i.ProtocolVersion !== a.clientProtocol)
                  ) {
                    h = r._.error(
                      r._.format(
